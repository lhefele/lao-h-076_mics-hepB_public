...
### sensitivity analysis: stratify according to recall or vaccination 
...
mics4.ch.wm_design_subset_b_vaccard %>% 
  ...
  as_hux_table() %>% 
  huxtable::quick_xlsx(file ="./tables/mics4_descriptive_ch_0-2_vac-card_bd.xlsx",
                       borders = 0.4,
                       open = interactive())
...
mics4.ch.wm_design_subset_b_recall %>% 
  ...
  as_hux_table() %>% 
  huxtable::quick_xlsx(file ="./tables/mics4_descriptive_ch_0-2_recall_bd.xlsx",
                       borders = 0.4,
                       open = interactive())
...
mics4.ch.wm_design_subset_p_vaccard %>% 
  ...
  as_hux_table() %>% 
  huxtable::quick_xlsx(file ="./tables/mics4_descriptive_ch_1-2_vac-card_p.xlsx",
                       borders = 0.4,
                       open = interactive())
...
mics4.ch.wm_design_subset_p_recall %>% 
  ...
  as_hux_table() %>% 
  huxtable::quick_xlsx(file ="./tables/mics4_descriptive_ch_1-2_recall_p.xlsx",
                       borders = 0.4,
                       open = interactive())
...
#tmap::tmap_save(map1_2012,"graphs/map1_12.png", width=7,height=12,units ="cm")
#tmap::tmap_save(map2_2012,"graphs/map2_12.png", width=7,height=12,units ="cm")
